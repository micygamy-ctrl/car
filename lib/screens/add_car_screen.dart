...
import '../data/car_makes_models.dart';
...
class _AddCarScreenState extends State<AddCarScreen> {
  ...
  List<String> get _modelsForMake {
    ...
    return carModelsByMake[_selectedMake] ?? [];
  }
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ListWheelScrollView.useDelegate(
                  controller:
                      FixedExtentScrollController(initialItem: now - tempYear),
                  itemExtent: 50,
                  perspective: 0.005,
                  diameterRatio: 1.5,
                  physics: const FixedExtentScrollPhysics(),
                  onSelectedItemChanged: (i) => setBS(() => tempYear = now - i),
  ...
  Future<void> _saveCar() async {
    ...
    if (_selectedYear == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
            content:
                Text('من فضلك اختار سنة الصنع', style: GoogleFonts.cairo())),
      );
      return;
    }
    ...
    try {
      ...
      final car = CarModel(
        ...
        oilChangeInterval:
            double.tryParse(_oilIntervalController.text.trim()) ?? 5000,
      ...
      for (final part in _parts) {
        ...
        final kmText =
            (part['kmController'] as TextEditingController).text.trim();
        final daysText =
            (part['daysController'] as TextEditingController).text.trim();
        ...
        final nextDueOdometer =
            intervalKm != null ? odometer + intervalKm : null;
      ...
      if (mounted) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content:
                Text('تمت إضافة السيارة بنجاح! 🚗', style: GoogleFonts.cairo()),
                        ...
                        if (_selectedMake == 'أخرى')
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration:
                                  _inputDeco('اكتب اسم الماركة', Icons.edit),
                              validator: (v) => _selectedMake == 'أخرى' &&
                                      (v == null || v.isEmpty)
  ...
  Widget _buildModelDropdown() {
    return DropdownSearch<String>(
      ...
      dropdownDecoratorProps: DropDownDecoratorProps(
        dropdownSearchDecoration: _inputDeco('الموديل', Icons.car_repair),
      ),
      popupProps: PopupProps.menu(
        showSearchBox: true,
        searchFieldProps: TextFieldProps(
        ...
        children: [
          Row(mainAxisAlignment: MainAxisAlignment.end, children: [
            Text('قطع السيارة والتذكيرات 🔧',
                style: GoogleFonts.cairo(
                    ...
                    color: const Color(0xFF8E24AA))),
            const SizedBox(width: 8),
            const Icon(Icons.build_circle, color: Color(0xFF8E24AA), size: 20),
          ]),
          const SizedBox(height: 4),
          ...
          ...List.generate(_parts.length, (index) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                color: enabled ? color.withAlpha(13) : const Color(0xFFF5F7FA),
                borderRadius: BorderRadius.circular(12),
                border: Border.all(
                    color: enabled
                        ? color.withAlpha(76)
                  ...
                  Row(
                    ...
                    children: [
                      Switch(
                          value: enabled,
                          onChanged: (v) =>
                              setState(() => _parts[index]['enabled'] = v),
                          activeColor: color),
                      Row(children: [
                        ...
                        Icon(part['icon'] as IconData,
                            color: enabled ? color : Colors.grey, size: 18),
                      ]),
                    ],
                  ),
                  if (enabled) ...[
                    ...
                    Row(children: [
                      Expanded(
                        child: TextFormField(
                          controller:
                              part['daysController'] as TextEditingController,
